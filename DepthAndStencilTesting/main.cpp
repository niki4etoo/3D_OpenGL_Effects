...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "DepthAndStencilTesting", NULL, NULL);
    if (window == NULL)
    {
    ...
    // -------------------------
    Shader shader("shaders/depth_testing_vertex.glsl", "shaders/depth_testing_fragment.glsl");
    Shader shaderSingleColor("shaders/depth_testing_vertex.glsl", "shaders/single_color_fragment.glsl");
    ...
    float wallsVertices[] = {
		//positions				//texture coords
		15.0f, -0.5f, 15.0f,		1.0f, 0.0f,
	   -15.0f, -0.5f, 15.0f,		0.0f, 0.0f,
	   -15.0f,  2.0f, 15.0f,		0.0f, 1.0f,
	   
	    15.0f, -0.5f, 15.0f,		1.0f, 0.0f,
	   -15.0f,  2.0f, 15.0f,		0.0f, 1.0f,
	    15.0f,  2.0f, 15.0f, 		1.0f, 1.0f,		
	};
