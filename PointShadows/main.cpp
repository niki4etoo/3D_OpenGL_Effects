...
const std::string title = "Point Shadows";
...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/point_shadows_vertex.glsl", "shaders/point_shadows_fragment.glsl");
    Shader simpleDepthShader("shaders/point_shadows_depth_vertex.glsl", "shaders/point_shadows_depth_fragment.glsl", "shaders/point_shadows_depth_geometry.glsl");

    // load textures
    // -------------
    stbi_set_flip_vertically_on_load(true);
    unsigned int woodTexture;
    TextureLoader tl1("textures/wood.png", woodTexture);
    ...
    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, 0, depthCubemap, 0);
