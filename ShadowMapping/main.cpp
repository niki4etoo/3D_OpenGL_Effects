...
int main()
{
    ...
    // -------------------------
    Shader shader("shaders/shadow_mapping_vertex.glsl", "shaders/shadow_mapping_fragment.glsl");
    Shader simpleDepthShader("shaders/shadow_mapping_depth_vertex.glsl", "shaders/shadow_mapping_depth_fragment.glsl");
    Shader debugDepthQuad("shaders/debug_quad_vertex.glsl", "shaders/debug_quad_fragment.glsl");
