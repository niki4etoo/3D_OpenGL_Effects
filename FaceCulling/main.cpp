...
const std::string title = "Face Culling";
...
int main() {
	...
	// -------------------------
	Shader shader("shaders/blending_vertex.glsl",
		      "shaders/blending_fragment.glsl");

	// set up vertex data (and buffer(s)) and configure vertex attributes (
	// Cube - for face culling ( all triangles are counter-clockwise order
	// of vertices )
	// ------------------------------------------------------------------
	float cubeVertices[] = {
	    // back face
	...
	/* Also make sure to add a call to OpenGL to specify that triangles
	   defined by a clockwise ordering are now 'front-facing' triangles so
	   the cube is rendered as normal: glFrontFace(GL_CW);
	*/
	...
	float wallsVertices[] = {
	    ...
	    15.0f, -0.5f, 15.0f,  3.0f, 0.0f,  -15.0f, -0.5f, 15.0f,
	    0.0f,  0.0f,  -15.0f, 2.0f, 15.0f, 0.0f,   3.0f,

	    15.0f, -0.5f, 15.0f,  3.0f, 0.0f,  -15.0f, 2.0f,  15.0f,
	    0.0f,  3.0f,  15.0f,  2.0f, 15.0f, 3.0f,   3.0f,
	};
	...
	TextureLoader tl4("textures/transparent_window.png",
			  transparentWindowTexture);
