...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("shaders/materials_vertex.glsl", "shaders/materials_fragment.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, glm::radians(10.0f * (float)glfwGetTime()), glm::vec3(0.5f, 0.5f, 0.0f));
